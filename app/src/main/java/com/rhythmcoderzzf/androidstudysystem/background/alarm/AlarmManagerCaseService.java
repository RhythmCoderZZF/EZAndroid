...
public class AlarmManagerCaseService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Notification notification = new Notification.Builder(this, CHANNEL_ID).setContentTitle("这是一条alarm测试通知").setContentText(content).setSmallIcon(com.rhythmcoderzzf.baselib.R.drawable.baseline_info_24).build();
